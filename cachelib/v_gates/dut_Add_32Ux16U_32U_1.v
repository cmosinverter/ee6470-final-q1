...
// Generated on: May 16 2023 20:52:40 CST (May 16 2023 12:52:40 UTC)
...
module dut_Add_32Ux16U_32U_1(in2, in1, out1);
  ...
  wire n_267, n_271, n_272, n_273, n_274, n_276, n_277, n_278;
  wire n_280, n_281, n_282, n_284, n_286, n_287, n_289, n_290;
  wire n_291, n_293, n_295, n_296, n_297, n_301, n_302, n_305;
  wire n_307, n_308, n_309, n_311, n_313, n_314, n_315, n_317;
  wire n_318, n_319, n_321, n_322, n_324, n_325, n_326, n_328;
  wire n_329, n_330, n_332, n_333, n_337, n_338, n_339;
  ...
  NOR2BX1 add_23_2_g870(.AN (add_23_2_n_140), .B (add_23_2_n_179), .Y
       (add_23_2_n_185));
  NOR2X1 add_23_2_g871(.A (n_321), .B (add_23_2_n_9), .Y
       (add_23_2_n_184));
  NOR2BX1 add_23_2_g872(.AN (n_289), .B (add_23_2_n_177), .Y
       (add_23_2_n_183));
  ...
  NOR2X6 add_23_2_g882(.A (add_23_2_n_160), .B (add_23_2_n_175), .Y
       (add_23_2_n_179));
  NOR2X1 add_23_2_g884(.A (n_308), .B (add_23_2_n_170), .Y
       (add_23_2_n_177));
  ...
  NOR2X1 add_23_2_g896(.A (add_23_2_n_155), .B (add_23_2_n_164), .Y
       (add_23_2_n_168));
  NOR2X1 add_23_2_g897(.A (add_23_2_n_66), .B (n_302), .Y
       (add_23_2_n_167));
  NOR2X1 add_23_2_g898(.A (add_23_2_n_89), .B (n_302), .Y
       (add_23_2_n_166));
  NOR2X6 add_23_2_g899(.A (add_23_2_n_128), .B (add_23_2_n_162), .Y
       (add_23_2_n_165));
  NOR2X1 add_23_2_g900(.A (add_23_2_n_131), .B (n_302), .Y
       (add_23_2_n_164));
  NOR2BX1 add_23_2_g901(.AN (n_280), .B (add_23_2_n_161), .Y
       (add_23_2_n_163));
  NOR2X6 add_23_2_g903(.A (add_23_2_n_117), .B (add_23_2_n_157), .Y
       (add_23_2_n_162));
  NOR2X1 add_23_2_g904(.A (n_286), .B (n_277), .Y (add_23_2_n_161));
  OAI21X2 add_23_2_g905(.A0 (add_23_2_n_136), .A1 (add_23_2_n_150), .B0
       (add_23_2_n_152), .Y (add_23_2_n_160));
  OAI21X1 add_23_2_g906(.A0 (add_23_2_n_101), .A1 (n_273), .B0 (n_295),
       .Y (add_23_2_n_159));
  OAI21X1 add_23_2_g907(.A0 (add_23_2_n_60), .A1 (n_271), .B0 (n_329),
       .Y (add_23_2_n_158));
  NOR2X6 add_23_2_g908(.A (add_23_2_n_98), .B (add_23_2_n_149), .Y
       (add_23_2_n_157));
  OAI21X1 add_23_2_g909(.A0 (add_23_2_n_135), .A1 (n_272), .B0
       (add_23_2_n_154), .Y (add_23_2_n_156));
  OAI21X1 add_23_2_g910(.A0 (add_23_2_n_43), .A1 (n_325), .B0 (n_314),
       .Y (add_23_2_n_155));
  OA21X1 add_23_2_g911(.A0 (n_317), .A1 (n_296), .B0 (add_23_2_n_74),
       .Y (add_23_2_n_154));
  OAI2BB1X1 add_23_2_g912(.A0N (add_23_2_n_45), .A1N (n_322), .B0
  ...
  NAND2X1 add_23_2_g994(.A (add_23_2_n_40), .B (add_23_2_n_48), .Y
       (add_23_2_n_82));
  NOR2BX1 add_23_2_g995(.AN (add_23_2_n_75), .B (n_293), .Y
       (add_23_2_n_97));
  NOR2X1 add_23_2_g996(.A (add_23_2_n_2), .B (n_305), .Y
       (add_23_2_n_96));
  NAND2BX1 add_23_2_g997(.AN (add_23_2_n_60), .B (n_328), .Y
       (add_23_2_n_95));
  NOR2X1 add_23_2_g998(.A (add_23_2_n_76), .B (n_284), .Y
       (add_23_2_n_94));
  NOR2X1 add_23_2_g999(.A (add_23_2_n_79), .B (add_23_2_n_59), .Y
       (add_23_2_n_81));
  NOR2BX1 add_23_2_g1000(.AN (add_23_2_n_58), .B (n_311), .Y
       (add_23_2_n_93));
  NAND2BX1 add_23_2_g1001(.AN (n_317), .B (add_23_2_n_74), .Y
       (add_23_2_n_92));
  ...
  NOR2BX1 add_23_2_g2(.AN (n_271), .B (add_23_2_n_176), .Y
       (add_23_2_n_19));
  XNOR2X1 add_23_2_g1074(.A (add_23_2_n_46), .B (add_23_2_n_81), .Y
       (out1[1]));
  NOR2BX1 add_23_2_g1075(.AN (n_324), .B (add_23_2_n_166), .Y
       (add_23_2_n_17));
  CLKXOR2X1 add_23_2_g1076(.A (add_23_2_n_112), .B (n_276), .Y
       (out1[2]));
  XNOR2X1 add_23_2_g1077(.A (add_23_2_n_109), .B (add_23_2_n_163), .Y
       (out1[3]));
  CLKXOR2X1 add_23_2_g1078(.A (add_23_2_n_108), .B (n_267), .Y
       (out1[8]));
  CLKXOR2X1 add_23_2_g1079(.A (add_23_2_n_107), .B (n_301), .Y
       (out1[4]));
  ...
  NOR2BX1 add_23_2_g1082(.AN (add_23_2_n_104), .B (add_23_2_n_124), .Y
       (add_23_2_n_10));
  NOR2BX1 add_23_2_g1083(.AN (n_337), .B (add_23_2_n_170), .Y
       (add_23_2_n_9));
  ...
  BUFX2 fopt(.A (add_23_2_n_170), .Y (n_267));
  CLKINVX1 fopt1093(.A (n_274), .Y (n_271));
  INVXL fopt1094(.A (n_274), .Y (n_272));
  CLKINVX1 fopt1095(.A (n_274), .Y (n_273));
  CLKINVX1 fopt1096(.A (add_23_2_n_150), .Y (n_274));
  INVXL fopt1097(.A (n_278), .Y (n_276));
  INVXL fopt1098(.A (n_278), .Y (n_277));
  INVXL fopt1099(.A (add_23_2_n_149), .Y (n_278));
  INVXL fopt1100(.A (n_282), .Y (n_280));
  INVXL fopt1101(.A (n_282), .Y (n_281));
  INVXL fopt1102(.A (add_23_2_n_56), .Y (n_282));
  BUFX2 fopt1103(.A (add_23_2_n_63), .Y (n_284));
  BUFX2 fopt1104(.A (n_287), .Y (n_286));
  INVXL fopt1105(.A (add_23_2_n_50), .Y (n_287));
  INVXL fopt1106(.A (n_291), .Y (n_289));
  INVXL fopt1107(.A (n_291), .Y (n_290));
  INVXL fopt1108(.A (add_23_2_n_55), .Y (n_291));
  BUFX2 fopt1109(.A (add_23_2_n_69), .Y (n_293));
  INVXL fopt1110(.A (n_297), .Y (n_295));
  INVXL fopt1111(.A (n_297), .Y (n_296));
  INVXL fopt1112(.A (add_23_2_n_124), .Y (n_297));
  BUFX2 fopt1114(.A (n_302), .Y (n_301));
  BUFX3 fopt1115(.A (add_23_2_n_162), .Y (n_302));
  BUFX2 fopt1116(.A (add_23_2_n_72), .Y (n_305));
  INVXL fopt1117(.A (n_309), .Y (n_307));
  INVXL fopt1118(.A (n_309), .Y (n_308));
  INVXL fopt1119(.A (add_23_2_n_57), .Y (n_309));
  BUFX2 fopt1120(.A (add_23_2_n_47), .Y (n_311));
  INVXL fopt1121(.A (n_315), .Y (n_313));
  INVXL fopt1122(.A (n_315), .Y (n_314));
  INVXL fopt1123(.A (add_23_2_n_53), .Y (n_315));
  INVXL fopt1124(.A (n_319), .Y (n_317));
  INVXL fopt1125(.A (n_319), .Y (n_318));
  INVXL fopt1126(.A (add_23_2_n_61), .Y (n_319));
  BUFX2 fopt1127(.A (n_322), .Y (n_321));
  INVXL fopt1128(.A (add_23_2_n_125), .Y (n_322));
  INVXL fopt1129(.A (n_326), .Y (n_324));
  INVXL fopt1130(.A (n_326), .Y (n_325));
  INVXL fopt1131(.A (add_23_2_n_127), .Y (n_326));
  INVXL fopt1132(.A (n_330), .Y (n_328));
  INVXL fopt1133(.A (n_330), .Y (n_329));
  INVXL fopt1134(.A (add_23_2_n_68), .Y (n_330));
  CLKINVX3 fopt1135(.A (add_23_2_n_71), .Y (n_332));
  BUFX2 fopt1136(.A (add_23_2_n_71), .Y (n_333));
  INVXL fopt1138(.A (n_339), .Y (n_337));
  INVXL fopt1139(.A (n_339), .Y (n_338));
  INVXL fopt1140(.A (add_23_2_n_103), .Y (n_339));
endmodule
